...
import 'package:zc_desktop_flutter/ui/shared/smart_widgets/emoji_selector/default_emoji_picker_view.dart';
...
import 'package:zc_desktop_flutter/ui/shared/smart_widgets/emoji_selector/recent_emoji.dart';
...
typedef void OnEmojiHovered(Category category, Emoji emoji);
...
typedef EmojiViewBuilder = Widget Function(
    EmojiConfig config, EmojiViewState state);
...
class ZcDesktopEmojiPicker extends StatefulWidget {
  /// EmojiPicker for flutter
  ZcDesktopEmojiPicker({
    Key? key,
    required this.onEmojiSelected,
    this.onBackspacePressed,
    this.config = const EmojiConfig(),
    this.customWidget,
  }) : super(key: key);
  ...
  /// EmojiConfig for customizations
  final EmojiConfig config;

  @override
  _ZcDesktopEmojiPickerState createState() => _ZcDesktopEmojiPickerState();
}

class _ZcDesktopEmojiPickerState extends State<ZcDesktopEmojiPicker> {
  static const platform = MethodChannel('emoji_picker_flutter');

  /// The function called when the emoji is hovered
  OnEmojiHovered? onEmojiHovered;
  ...
  @override
  void didUpdateWidget(covariant ZcDesktopEmojiPicker oldWidget) {
    if (oldWidget.config != widget.config) {
      // EmojiConfig changed - rebuild EmojiPickerView completely
      loaded = false;
    }
