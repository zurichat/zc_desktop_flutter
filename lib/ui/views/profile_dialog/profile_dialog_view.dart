...
import 'package:zc_desktop_flutter/ui/views/profile_dialog/profile_dialog_view_model.dart';
      ...
      child: Row(
        ...
        children: [
          ...
          Padding(
            ...
            child:
                Align(alignment: Alignment.topRight, child: IconButton(onPressed:model.popDialog ,icon:Icon(Icons.close))),
          )
        ],
      ),
    );
  ...
  buildDetailsContainer() {
    return Container(
      ...
      decoration: BoxDecoration(
          border: Border.all(color: Color.fromRGBO(153, 153, 153, 1)), borderRadius: BorderRadius.circular(10)),
      child: Column(
