...
class MarkMessageAsReadResponse with _$MarkMessageAsReadResponse{
  factory MarkMessageAsReadResponse({@Default(false) bool read})= _MarkMessageAsReadResponse;

    factory MarkMessageAsReadResponse.fromJson(Map<String, dynamic> json) => _$MarkMessageAsReadResponseFromJson(json);
...
class RoomInfoResponse with _$RoomInfoResponse{
  ...
  factory RoomInfoResponse(
      ...
      @JsonKey(name: 'room_id') required String roomId,
      @JsonKey(name: 'room_user_ids') required List<String> roomUserIds})= _RoomInfoResponse;
...
class DummyUser with _$DummyUser{
  factory DummyUser({String? name, @JsonKey(name: 'profileImage') String? profileImage,@Default(1) int id})= _DummyUser;

    factory DummyUser.fromJson(Map<String, dynamic> json) => _$DummyUserFromJson(json);
...
abstract class BaseChat with _$BaseChat{
  factory BaseChat({List<Chat>? chats})= _BaseChat;
               factory BaseChat.fromJson(Map<String, dynamic> json) => _$BaseChatFromJson(json);
