...
import 'package:zc_desktop_flutter/models/preferences_model/audio_and_video/audio_and_video.dart';
...
class LocalStorageService {
  ...
  AuthResponse? get authResponse {
    ...
    return AuthResponse.fromMap(jsonDecode(authResponseJson.toString()));
  }
  ...
  static Future<LocalStorageService> getInstance() async {
    ...
    if (_preferences == null) {
      widget.WidgetsFlutterBinding.ensureInitialized();
