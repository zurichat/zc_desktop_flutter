...
class ZuriApiService implements Api {
  ...
  Future<dynamic> patch(
    ...
    log.i('Making request to $uri');
    try {
      final response = await dio.patch(uri.toString(),
          data: body, options: Options(headers: headers));
  ...
  @override
  Future<String> addLoggedInUserToOrganization(
  ...
  Future<void> updateUserDetails(
      {required String organizationId,
      required String memberId,
      required UpdateUserParam parameter,
      required String token}) async {
    await patch(updateUserProfile(organizationId, memberId),
